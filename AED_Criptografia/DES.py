# DES completo em Python com criptografia e decriptação
...
def des_encrypt(binary_text64, key64):
    return des_block_encrypt(binary_text64, generate_keys(key64))

def des_decrypt(cipher64, key64):
    return des_block_decrypt(cipher64, generate_keys(key64))
